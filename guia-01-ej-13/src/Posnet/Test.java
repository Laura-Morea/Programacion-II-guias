...
POSNET que procesa pagos con tarjetas de crédito. Las 
tarjetas de crédito guardan el nombre de la entidad 
...
apellido, fecha de nacimiento y domicilio). Cada vez que se 
cree una nueva tarjeta, deberán indicarse todos estos datos. 
